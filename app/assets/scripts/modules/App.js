(function() {
    ...
    var assetLoader = (function() {
        ...
        function assetLoaded(dic, name) {
            ...
            // finished callback
            if (
                assetsLoaded === this.totalAssest &&
                typeof this.finished === "function"
            ) {
                this.finished();
            }
        }
    ...
    var background = (function() {
        ...
        this.draw = function() {
            ...
            ctx.drawImage(
                assetLoader.imgs.backdrop,
                backdrop.x + canvas.width,
                backdrop.y
            );

            ctx.drawImage(assetLoader.imgs.backdrop2, backdrop2.x, backdrop2.y);
            ctx.drawImage(
                assetLoader.imgs.backdrop2,
                backdrop2.x + canvas.width,
                backdrop2.y
            );
    ...
    function startGame() {
        ...
        player.height = 96;
        player.speed = 6;
        player.sheet = new SpriteSheet(
            "assets/images/normal_walk.png",
            player.width,
            player.height
        );
        ...
        for (
            i = 0, length = Math.floor(canvas.width / platformWidth) + 2;
            i < length;
            i++
        ) {
